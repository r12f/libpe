...
#define FILE_PARSING_RESULT_NAME    LIBPE_T("FileParsingResult.xml")
...
int wmain(int /*argc*/, wchar_t* /*argv*/[])
{
    static const TestCase testCases[] = {
        { LIBPE_T("x86Dll"), LIBPE_T("Test.dll") },
        { LIBPE_T("x86Exe"), LIBPE_T("Test.exe") },
        { LIBPE_T("x64Dll"), LIBPE_T("Test.dll") },
        { LIBPE_T("x64Exe"), LIBPE_T("Test.exe") },
    };
