...
typedef IPEOverlay32                    IPEOverlay;
...
typedef IPEResourceDirectory32          IPEResourceDirectory;
typedef IPEResourceDirectoryEntry32     IPEResourceDirectoryEntry;
typedef IPEResourceDataEntry32          IPEResourceDataEntry;
typedef IPEResource32                   IPEResource;
...
typedef IPEOverlay64                    IPEOverlay;
...
typedef IPEResourceDirectory64          IPEResourceDirectory;
typedef IPEResourceDirectoryEntry64     IPEResourceDirectoryEntry;
typedef IPEResource64                   IPEResource;
typedef IPEResourceDataEntry64          IPEResourceDataEntry;
